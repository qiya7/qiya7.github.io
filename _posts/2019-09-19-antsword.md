...
#### 二、复现过程
- phpstudy网站根目录添加webshell文件，测试存在XSS
![](https://qiya7.github.io/images/antsword/1.png)

- phpstudy网站根目录添加webshell文件，内容如下
```php
<?php
...
?>
```
- 特别需要注意webshell的内容是base64编码之后的，编码之前如下，，是js调用cmd反弹shell（仅限在Electron）
...
```
- 本地nc监听端口
![](https://qiya7.github.io/images/antsword/2.png)

- 使用蚁剑访问webshell
![](https://qiya7.github.io/images/antsword/3.png)

- webshell反弹成功
![](https://qiya7.github.io/images/antsword/4.png)

#### 三、总结
- 适用范围：挂一个webshell在服务器上，等别人用蚁剑来连，连接之后就算蚁剑关闭，shell仍存在，除非重启机器
